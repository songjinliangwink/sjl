...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="teacherid" id = "txt_search_teacherid" aria-required="true" required>
						<option value="">---请选择---</option>
						<c:forEach items="${teachList }" var="t">
	...
	<div class="modal fade" id="modal_user_add1" role="dialog" aria-labelledby="modal_user_add1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_add1" method="post" action="add1Student.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>教师姓名：</td>
								<td><input type="text" id="name" name="name"
	    		    ...
	    		    success:function(res){
	    		    	if(res.success){
	    	    			...
	    	    			res.list.forEach(function(studentVo) {
	    	    				xdata.push(studentVo.name);
	    	    				ydata.push({value:studentVo.num, name: studentVo.name});
							})
	    	    		}
