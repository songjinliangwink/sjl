...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			<div class="input-group">
			      ...
			      <input type="text" name="expressName" class="form-control" id="a_expressName" >
				</div>
			  </div>
			  
				<div class="input-group">
					<span class="input-group-addon">公司</span>
					<select class="form-control" name="expressTypeId" id = "a_expressTypeId">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<td>特点：</td>
								<td>
									...
									<input type="checkbox" id="expressTrait3" name="expressTrait"  aria-required="true" required value="勇敢"/>勇敢
								</td>
								<td>所属公司：</td>
								<td colspan="4">
									<select class="form-control" name="expressTypeId" id ="expressTypeId" aria-required="true" required>
										...
										<c:forEach items="${clist }" var="c">
										 	<option value="${c.id }">${r.expressName }</option>
										</c:forEach>
				                	</select>
								</td>
							</tr>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            expressName: $("#a_expressName").val(),
	            expressTypeId: $("#a_expressTypeId").val(),
    			    ...
    			    success:function(res){
    			    	...
    			    	if(res.success){
    		    			...
    		    			res.elist.forEach(function(obj){
    		    				xdata.push(obj.ename);
    		    				ydata.push({value:obj.num,name:obj.ename});
    		    			});
    		    			//设置图表  饼状图
    		    			option = {
	    			    		    title: {
	...
	function initEditUser(getSelection){
		...
		$("#expressTrait3").prop("checked",getSelection.expressTrait.indexOf("勇敢")!=-1);
